...
(self.webpackChunkkelbi_launcher = self.webpackChunkkelbi_launcher || []).push([[179], { 6981: function (e, t, n) {
            ...
            var Uo = io().shape({ username: zr().required("Campo obrigatório."), password: zr().min(6, "Senha muito curta.").required("Campo obrigatório."), autoLogin: Tr().required("Campo obrigatório.") });
            ...
            function pi() { var e = ii(), t = e.mutate, n = e.isLoading, o = si((0, r.useState)(null), 2), i = o[0], a = o[1], u = function () { var e, t, n = (e = (0, r.useState)({ loading: !0, characters: [], newAccountUID: "" }), t = 2, function (e) { if (Array.isArray(e))
                ...
                i({ loading: !1, characters: a, newAccountUID: o });
            } }), 100); return function () { return clearInterval(e); }; }), []), ui(ui({}, o), {}, { isNewAccount: 0 === o.characters.length }); }(), l = u.characters, c = u.isNewAccount, s = u.newAccountUID, f = u.loading, p = si((0, r.useState)(""), 2), d = p[0], h = p[1], v = null != i ? i : "Buscando seus dados...", y = function () { new Audio(Vn).play(), a("Abrindo o jogo..."), Fo(null != d ? d : s); }, g = function () { a("Trocando de conta..."), localStorage.removeItem("autoLogin"), localStorage.removeItem("password"), localStorage.removeItem("username"), window.external.restartMhf(); }; return null !== i || f ? r.createElement(hi, { message: v }) : c ? r.createElement("div", null, r.createElement("h4", { className: "text-center" }, "Bem vindo! Esperamos que você se divirta e faça novas amizades. Estamos no", " ", r.createElement("span", { onClick: function () { return xo(); }, style: { color: "#7289DA" } }, "Discord"), " ", "para ajudar no que for possível, então qualquer dúvida ou sugestão entre em contato.", r.createElement("br", null), "~ Grato Invasores"), r.createElement("div", { className: "flex items-center justify-center flex-col" }, r.createElement(Zn, { onClick: y }, "Entrar"), r.createElement(Zn, { onClick: g }, "Trocar de conta"))) : r.createElement("div", null, r.createElement("div", { style: { overflowY: "auto", maxHeight: "70%", paddingRight: 10, marginTop: 50, top: 0, position: "absolute", marginLeft: 400 } }, l.map((function (e, t) { return r.createElement(ti, { char: e, key: e.uid, tabIndex: t, isSelected: e.uid === d, onSelect: function () { Gn(), h((function (t) { return t === e.uid ? null : e.uid; })); } }); }))), r.createElement("div", { className: "flex flex-col items-center" }, r.createElement(Zn, { onClick: y, disabled: !d || n }, "Entrar"), r.createElement(Zn, { onClick: t, loadingMessage: "Criando novo personagem...", isLoading: n }, "Novo personagem"), r.createElement(Zn, { onClick: g, disabled: n }, "Trocar de conta"), r.createElement(di, null))); }
